...
suite("newlines", () => {
	...
	const testdata = {
		...
		"CRLF leading block comment": ["/*foo*/\r\nvar x;", "var x;"],
...
suite("pathological input", () => {
	suite("general", () => {
		...
		const testdata = {
			...
			"division, after void": ["void /x/; y / z; // a", "void /x/; y / z;"],
	...
	suite("regexp", () => {
		suite("general", () => {
			...
			const templates = {
				...
				"arithmetic division, dividend": "var d = %s / 1;",
				"arithmetic division, divisor": "var d = 1 / %s;",
